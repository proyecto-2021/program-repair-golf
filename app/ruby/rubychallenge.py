...
class RubyChallenge:
	...
	def __init__(self, repair_objective, complexity, best_score=0, code=None, tests_code=None, id=None):
        ...
        Parameters:
            repair objective (string): set the challenge repair objective,
            complexity (string): set the challenge complexity,
            best_score (integer): set the challenge score to 0, 
            code (RubyCode): set the challenge file code,
            tests_code (RubyTestsCode): set the challenge tests suite,
	...
	def get_content(self, exclude=[], for_db=False):
        ...
        Parameters:
            exclude (list): list of attributes to exluding,
