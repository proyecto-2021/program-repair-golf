...
def test_update_simple_fields(client, jwt_token):
    ...
    response = client.get(api_url + '/' + str(challenge_id), headers={'Authorization': f'JWT {jwt_token}'})
    assert response.json == update_expected_response

def test_update_valid_code(client, jwt_token):
    post_info = send_post(client, jwt_token, "valid_code_9.py", "valid_atest_9.py", "Make all tests pass.", "1")
...
def test_update_not_compiling_code(client, jwt_token):
    post_info = send_post(client, jwt_token, "valid_code_10.py", "valid_atest_10.py", "Make all tests pass.", "1")
...
def test_update_repaired_code(client, jwt_token):
    post_info = send_post(client, jwt_token, "valid_code_11.py", "valid_atest_11.py", "Make all tests pass.", "1")
...
def test_update_test_invalid_import(client, jwt_token):
    post_info = send_post(client, jwt_token, "valid_code_12.py", "valid_atest_12.py", "Make all tests pass.", "1")
    challenge_id = post_info.json['challenge']['id']
...
def test_update_code_name_fails(client, jwt_token):
    post_info = send_post(client, jwt_token, "valid_code_19.py", "valid_atest_19.py", "Make all tests pass.", "1")
    challenge_id = post_info.json['challenge']['id']
    post_info = send_post(client, jwt_token, "valid_code_20.py", "valid_atest_20.py", "Make all tests pass.", "1")
...
def test_update_all_code_name_conflict(client, jwt_token):
    post_info = send_post(client, jwt_token, "valid_code_14.py", "valid_atest_14.py", "Make all tests pass.", "1")
    challenge_id = post_info.json['challenge']['id']
